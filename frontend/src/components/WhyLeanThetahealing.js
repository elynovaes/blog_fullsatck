const WhyLearnThetahealing = ({ data3 }) => {
  return (
    <section className="bg-meditando bg-cover bg-center w-full px-6 py-12">
      ...
      <div className="flex flex-col md:flex-row max-w-screen-xl justify-center items-center sm:items-end gap-8 mx-auto">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <h1 className="font-genty mb-5"><mark className="bg-primary text-white text-4xl sm:text-5xl sm:leading-tight">{data3.titleWlthetahealingSection}</mark></h1>
          ...
          <div className="flex space-y-4 mb-8 gap-6">
            ...
            <div className="pt-2">
              <ul className="text-white text-2xl sm:text-3xl space-y-11">
                <li>{data3.item1WlthetahealingSection}</li>
                <li>{data3.item2WlthetahealingSection}</li>
                <li>{data3.item3WlthetahealingSection}</li>
                <li>{data3.item4WlthetahealingSection}</li>
              </ul>
            </div>              
          </div>
        </div>
        ...
        <div className="w-full lg:w-4/12">
          <div className="bg-tertiary w-max hover:bg-pink-600 text-white font-bold py-2 px-12 sm:px-20 rounded mx-auto">
            <a className="block" href={data3.btnWlthetahealingSectionLink}>{data3.btnWlthetahealingSection}</a>
          </div>
        </div>
...
export default WhyLearnThetahealing