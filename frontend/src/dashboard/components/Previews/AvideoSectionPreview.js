const AvideoSectionPreview = ({ field }) => {
  return (
    <section className="bg-gradient-to-b from-gray-300 md:from-white to-pink-900 w-full px-6 pt-12 pb-44 lg:pb-0 relative z-0">
      ...
      <div className="max-w-screen-xl mx-auto text-center relative">
        ...
        <p className="max-w-lg mx-auto">{field.paragraph}</p>
        ...
        <img className="hidden lg:block absolute top-52 right-52" src={field.img} alt="asdfasdfsa" />
        ...
        <div className="mt-10 lg:mt-28 pb-10 relative h-auto lg:h-576px grid grid-cols-1 md:grid-cols-2 lg:block justify-items-center gap-10">
          ...
          <div className="text-white flex flex-col justify-center w-80 gap-2 static lg:absolute top-12 left-5">
            <h3 className="font-bold text-2xl">{field.titlev1}</h3>
            <img className="w-3/4 mx-auto" src={field.imgv1} alt="dadfasdf" />
            <p>{field.pv1}</p>
          </div>

          <div className="text-white flex flex-col justify-center w-80 gap-2 static lg:absolute top-48 right-0">
            <h3 className="font-bold text-2xl">{field.titlev2}</h3>
            <img className="w-3/4 mx-auto" src={field.imgv2} alt="asdfasdfasdf" />
            <p>{field.pv2}</p>
          </div>

          <div className="text-white flex flex-col justify-center w-80 gap-2 static lg:absolute top-96 left-0">
            <h3 className="font-bold text-2xl">{field.titlev3}</h3>
            <img className="w-3/4 mx-auto" src={field.imgv3} alt="asdfasdfsa" />
            <p>{field.pv3}</p>
          </div>

          <div className="text-white flex flex-col justify-center w-80 gap-2 static lg:absolute bottom-96 right-20">
            <h3 className="font-bold text-2xl">{field.titlev4}</h3>
            <img className="w-3/4 mx-auto" src={field.imgv4} alt="asdfasdfsa" />
            <p>{field.pv4}</p>
          </div>

          <div className="text-white flex flex-col justify-center w-80 gap-2 static lg:absolute bottom-48 left-20">
            <h3 className="font-bold text-2xl">{field.titlev5}</h3>
            <img className="w-3/4 mx-auto" src={field.imgv5} alt="asdfasdfsa" />
            <p>{field.pv5}</p>
          </div>
        </div>
...
export default AvideoSectionPreview